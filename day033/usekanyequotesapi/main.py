...
background_img = PhotoImage(file="C:/100daysofcode/day033/usekanyequotesapi/background.png")
canvas.create_image(150, 207, image=background_img)
quote_text = canvas.create_text(150, 207, text="Kanye Quote Goes HERE", width=250, font=("Arial", 18, "bold"), fill="white")
canvas.grid(row=0, column=0)

kanye_img = PhotoImage(file="C:/100daysofcode/day033/usekanyequotesapi/kanye.png")
